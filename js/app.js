...
const WORDS=[
  ...
  {k:'走る',r:'はしる',m:'to run',t:'godan',jlpt:4,exc:true},
  {k:'切る',r:'きる',m:'to cut',t:'godan',jlpt:4,exc:true},
  {k:'作る',r:'つくる',m:'to make, to create',t:'godan',jlpt:4},
  {k:'送る',r:'おくる',m:'to send',t:'godan',jlpt:4},
  {k:'帰る',r:'かえる',m:'to return home',t:'godan',jlpt:5,exc:true},
  ...
  {k:'知る',r:'しる',m:'to know',t:'godan',jlpt:4,exc:true},
  {k:'座る',r:'すわる',m:'to sit',t:'godan',jlpt:4},
  {k:'取る',r:'とる',m:'to take',t:'godan',jlpt:4},
  {k:'入る',r:'はいる',m:'to enter',t:'godan',jlpt:4,exc:true},
  ...
  {k:'置く',r:'おく',m:'to put, to place',t:'godan',jlpt:4},
  {k:'出す',r:'だす',m:'to take out, to submit',t:'godan',jlpt:4},
  {k:'返す',r:'かえす',m:'to return (something)',t:'godan',jlpt:4},
  {k:'休む',r:'やすむ',m:'to rest',t:'godan',jlpt:5},
  {k:'泣く',r:'なく',m:'to cry',t:'godan',jlpt:4},
  {k:'笑う',r:'わらう',m:'to laugh',t:'godan',jlpt:4},
  {k:'怒る',r:'おこる',m:'to get angry',t:'godan',jlpt:4},
  {k:'違う',r:'ちがう',m:'to differ, to be wrong',t:'godan',jlpt:4},
  {k:'探す',r:'さがす',m:'to search for',t:'godan',jlpt:4},
  {k:'習う',r:'ならう',m:'to learn',t:'godan',jlpt:4},
  {k:'手伝う',r:'てつだう',m:'to help',t:'godan',jlpt:4},
  {k:'止まる',r:'とまる',m:'to stop',t:'godan',jlpt:4},
  {k:'曲がる',r:'まがる',m:'to turn',t:'godan',jlpt:4},
  {k:'開く',r:'あく',m:'to open (intrans.)',t:'godan',jlpt:4},
  {k:'閉まる',r:'しまる',m:'to close (intrans.)',t:'godan',jlpt:4},
  {k:'渡る',r:'わたる',m:'to cross',t:'godan',jlpt:4},
  {k:'動く',r:'うごく',m:'to move',t:'godan',jlpt:3},
  {k:'直す',r:'なおす',m:'to fix, to correct',t:'godan',jlpt:3},
  {k:'壊す',r:'こわす',m:'to break (trans.)',t:'godan',jlpt:3},
  ...
  {k:'考える',r:'かんがえる',m:'to think, to consider',t:'ichidan',jlpt:4},
  {k:'見える',r:'みえる',m:'to be visible',t:'ichidan',jlpt:4},
  {k:'聞こえる',r:'きこえる',m:'to be audible',t:'ichidan',jlpt:4},
  {k:'見つける',r:'みつける',m:'to find',t:'ichidan',jlpt:3},
  {k:'受ける',r:'うける',m:'to receive, to take (exam)',t:'ichidan',jlpt:3},
  ...
  {k:'練習する',r:'れんしゅうする',m:'to practice',t:'irregular',jlpt:4},
  {k:'準備する',r:'じゅんびする',m:'to prepare',t:'irregular',jlpt:3},
  {k:'紹介する',r:'しょうかいする',m:'to introduce',t:'irregular',jlpt:3},
  {k:'説明する',r:'せつめいする',m:'to explain',t:'irregular',jlpt:3},
  ...
  {k:'面白い',r:'おもしろい',m:'interesting, funny',t:'i-adj',jlpt:4},
  {k:'すごい',r:'すごい',m:'amazing',t:'i-adj',jlpt:4},
  {k:'怖い',r:'こわい',m:'scary',t:'i-adj',jlpt:4},
  {k:'可愛い',r:'かわいい',m:'cute',t:'i-adj',jlpt:4},
  {k:'暖かい',r:'あたたかい',m:'warm',t:'i-adj',jlpt:4},
  {k:'涼しい',r:'すずしい',m:'cool (weather)',t:'i-adj',jlpt:4},
  {k:'重い',r:'おもい',m:'heavy',t:'i-adj',jlpt:4},
  {k:'軽い',r:'かるい',m:'light (weight)',t:'i-adj',jlpt:4},
  {k:'明るい',r:'あかるい',m:'bright',t:'i-adj',jlpt:4},
  {k:'暗い',r:'くらい',m:'dark',t:'i-adj',jlpt:4},
  {k:'甘い',r:'あまい',m:'sweet',t:'i-adj',jlpt:4},
  {k:'辛い',r:'からい',m:'spicy',t:'i-adj',jlpt:4},
  {k:'うるさい',r:'うるさい',m:'noisy',t:'i-adj',jlpt:4},
  {k:'汚い',r:'きたない',m:'dirty',t:'i-adj',jlpt:4},
  {k:'つまらない',r:'つまらない',m:'boring',t:'i-adj',jlpt:4},
  // === NA-ADJECTIVES ===
  ...
  {k:'大切',r:'たいせつ',m:'important, precious',t:'na-adj',jlpt:4},
  {k:'親切',r:'しんせつ',m:'kind',t:'na-adj',jlpt:4},
